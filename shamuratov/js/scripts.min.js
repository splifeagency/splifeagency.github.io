...
function initMap(){var e=new google.maps.LatLng($("#map").attr("lat"),$("#map").attr("lon")),t={center:e,zoom:17,scrollwheel:!1,styles:[{elementType:"geometry",stylers:[{color:"#f5f5f5"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f5f5"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#ffffff"}]},{featureType:"road.arterial",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#dadada"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#c9c9c9"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]}]},l=new google.maps.Map(document.getElementById("map"),t);new google.maps.Marker({position:e,map:l,icon:"img/map-marker.png"})}$(function(){$(".block-price-extra-more a").click(function(){$(this).parent().parent().toggleClass("active"),$(this).html("Скрыть"==$(this).html()?"Узнать больше":"Скрыть")}),$(".match-height").matchHeight(),$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black","fx-listitems-fade"],navbar:{title:'<img src="img/logo.png" alt="" />'},offCanvas:{position:"right"}});var e=$("#my-menu").data("mmenu");e.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),e.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$("a[href='#callback']").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom"}),$("#callback").validate({submitHandler:function(e){e.submit()},errorPlacement:function(e,t){}}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".b-question-item").click(function(){$(this).find(".b-question-answer").slideToggle("fast")}),$(".sertificates").owlCarousel({loop:!1,margin:10,nav:!1,dots:!0,smartSpeed:700,responsive:{0:{items:1},600:{items:2},1e3:{items:3},1200:{items:5}}}),$(".sertificates a").simpleLightbox(),$(".testimonials").owlCarousel({loop:!0,nav:!0,dots:!0,smartSpeed:700,navText:["",""],responsive:{0:{items:1},600:{items:1},1e3:{items:1}}})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});